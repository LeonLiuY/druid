...
public class DruidTest {
    ...
    public void druidTest() throws IOException {
        Map<String, Integer> result = runner.run(" var a;" + " var b;"
                + " var c;" + " var d;" + " a = 1;" + " b = a;" + " c <- a;"
                + " a = 2;");
    ...
    public void testMultiDefinition() throws IOException {
        Map<String, Integer> result = runner.run(" var a, b;" + " a = 1;"
                + " b = a;" + " var c, d;" + " c <- a;" + " a = 2;");
        System.out.println(result);
        assertEquals(new Integer(2), result.get("a"));
        assertEquals(new Integer(1), result.get("b"));
        ...
        try {
            runner.run(" var a;" + " b = 1;" + " var b;" + " a = 2;");
        } catch (IllegalStateException e) {
